...
function Office() {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:3000/employee/office_location')
      .then(response => {
  ...
  const handleDeleteLocation = (id) => {
    ...
    axios.delete(`http://localhost:3000/employee/office_location/${id}`)
      .then(response => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:3000/employee/office_location', newLocation)
      .then(response => {
